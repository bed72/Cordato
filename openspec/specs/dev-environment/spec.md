...
Define the reproducible development environment and quality tooling for the project: UV-managed
dependencies, a pinned Python version, Ruff linting/formatting, pytest, mypy, a canonical set of
quality commands, and poethepoet task runner shortcuts — all runnable after a plain `uv sync` with no
